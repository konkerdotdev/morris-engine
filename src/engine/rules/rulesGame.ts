...
export const RulesGame = () =>
  P.pipe(
    R.createRuleSet<never, MorrisRulesContextGame, MorrisEngineError, MorrisFactsGame>(INITIAL_MORRIS_FACTS_GAME),

    // is
    R.sequence([
      R.addRuleFunc(
        'isFirstMove',
        (c: MorrisRulesContextGame, _f: MorrisFactsGame) => {
      ...
      R.addRuleFunc(
        'isSecondMove',
        (c: MorrisRulesContextGame, _f: MorrisFactsGame) => gameHistoryLen(c.game.gameState.history) === 1,
        'Is second move'
      ),
      R.addRuleFunc(
        'isTurnWhite',
        (c: MorrisRulesContextGame, _f: MorrisFactsGame) => c.moveFacts.moveMakesNextTurnWhite,
        'Is current turn white'
      ),
      R.addRuleFunc(
        'isTurnBlack',
        (c: MorrisRulesContextGame, _f: MorrisFactsGame) => c.moveFacts.moveMakesNextTurnBlack,
      ...
      R.addRuleFunc(
        'isRemoveMode',
        (c: MorrisRulesContextGame, _f: MorrisFactsGame) => c.moveFacts.moveMakesRemoveMode,
        'Is in remove mode for current player: last move was a mill'
      ),
      R.addRuleFunc(
        'isMillMadeWhite',
        (c: MorrisRulesContextGame, _f: MorrisFactsGame) => c.moveFacts.moveMakesMillWhite,
        'The last move was a mill for white'
      ),
      R.addRuleFunc(
        'isMillMadeBlack',
        (c: MorrisRulesContextGame, _f: MorrisFactsGame) => c.moveFacts.moveMakesMillBlack,
        'The last move was a mill for black'
      ),
      R.addRuleFunc(
        'isMillMade',
        (_c: MorrisRulesContextGame, f: MorrisFactsGame) => f.isMillMadeWhite || f.isMillMadeBlack,
      ...
      R.addRuleFunc(
        'isDraw',
        (_c: MorrisRulesContextGame, f: MorrisFactsGame) => f.isDrawPositionRepeatLimit || f.isDrawNoMillsLimit,
      ...
      R.addRuleFunc(
        ...
        (c: MorrisRulesContextGame, f: MorrisFactsGame) => f.isNoValidMoveBlack && c.moveFacts.moveMakesNextTurnBlack,
        'The result is a win for white due to no valid move for black'
      ),
      R.addRuleFunc(
        'isWinWhite',
        (_c: MorrisRulesContextGame, f: MorrisFactsGame) =>
      ...
      R.addRuleFunc(
        ...
        (c: MorrisRulesContextGame, f: MorrisFactsGame) => f.isNoValidMoveWhite && c.moveFacts.moveMakesNextTurnWhite,
      ...
      R.addRuleFunc(
        'isWin',
        (_c: MorrisRulesContextGame, f: MorrisFactsGame) => f.isWinWhite || f.isWinBlack,
        'The move is a winning move: either for white or black'
      ),
      R.addRuleFunc(
        'isGameOver',
        (_c: MorrisRulesContextGame, f: MorrisFactsGame) => f.isDraw || f.isWin,
