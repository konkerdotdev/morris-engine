...
export const P_9 = 24;
export type P_9 = typeof P_9;
export const D_9 = 7;
export type D_9 = typeof D_9;
export const N_9 = 9;
...
1  o--------------o--------------o
   a    b    c    d    e    f    g
*/
export const board: MorrisBoard<P_9, D_9, N_9> = {
  numPoints: P_9,
  dimension: D_9,
  points: [
    {
...
// --------------------------------------------------------------------------
export const config: MorrisGameConfig<N_9> = {
  name: "9 Men's Morris",
...
export const game: MorrisGame<P_9, D_9, N_9> = {
  config,
