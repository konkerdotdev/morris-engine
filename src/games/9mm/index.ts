...
export function Game9mm(gameState: MorrisGameState = initialGameState): MorrisGame {
  return {
    gameState,
    initMorrisBoard,
    initMorrisWhite,
...
export type Game9mm = ReturnType<typeof Game9mm>;

export const Game = Game9mm;
